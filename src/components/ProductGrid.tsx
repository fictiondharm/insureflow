...
const products = [
  {
    ...
    desc: "Your flight is delayed 4+ hours. You get paid automatically. No forms, no queues, no fighting with airlines.",
    features: ["4hr delay threshold", "Any airline, global", "Instant payout on trigger"],
    price: "$12.50",
    accent: "text-coral",
    accentName: "coral",
  ...
  },
  {
    ...
    bg: "bg-jade/[0.02]",
    Illus: RainCardIllus,
    features: ["Custom mm threshold", "Weather oracle verified", "96hr before event cover"],
  },
  {
    id: "shipping",
